...
@Schema(description = "DTO para actualizar aeronave existente")
@ValidAircraftModel(groups = ValidationGroups.Update.class)
public class AircraftUpdateDto {

    @Size(min = 2, max = 100, message = "Name must be between 2 and 100 characters")
    @Schema(description = "Nombre de la aeronave", example = "Boeing 737 MAX 8")
    private String name;

    @Size(min = 2, max = 50, message = "Model must be between 2 and 50 characters")
    @Schema(description = "Modelo específico", example = "737 MAX 8")
    ...
    @Schema(description = "ID del tipo", example = "2")
    private Long typeId;
    ...
    @Schema(description = "Año de introducción", example = "2016")
    ...
    @Schema(description = "Alcance en km", example = "6570")
    ...
    @Schema(description = "Velocidad de crucero en nudos", example = "453")
    ...
    @Schema(description = "Aeronave activa", example = "true")
    private Boolean isActive;

    // Constructors
    public AircraftUpdateDto() {}

    // Getters and Setters (idénticos a AircraftCreateDto)
